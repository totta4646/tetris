...
@interface playView : UIViewController {
    ...
    UIView *stage, *dropStage,*scoreboard,*holdView,*nextView,*pauseView;
    ...
    UIColor *tempColor;
    UIButton *DOWNBUTTON, *LEFTBUTTON, *RIGHTBUTTON, *TURNBUTTON,*HOLDBUTTON,*PAUSEBUTTON,*RESETBUTTON,*RESUMEBUTTON,*HOMEBUTTON;
